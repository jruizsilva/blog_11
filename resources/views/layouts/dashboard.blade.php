    ...
    <div x-on:click.away="open = false"
      ...
      <nav x-data="{
        ...
        <ul class="space-y-1.5">
          <li>
            <x-sidebar.anchor label="Dashboard" route="dashboard.index" leftIcon="fa-solid fa-home"/>
          </li>
          <li x-data="{open: false}">
            <x-sidebar.button x-on:click="open = !open" label="Posts" leftIcon="fa-solid fa-layer-group" rightIcon="fa-solid fa-angle-down"/>

            <ul class="pt-2 ps-3" x-bind:class="open ? '' : 'hidden'">
                <li>
                  <x-sidebar.anchor label="Crear nuevo post" route="dashboard.posts.create" leftIcon="fa-solid fa-plus"/>
                </li>
                <li>
                  <x-sidebar.anchor label="Lista de posts" route="dashboard.posts.index" leftIcon="fa-solid fa-layer-group"/>
                </li>
            </ul>
          </li>
        </ul>
